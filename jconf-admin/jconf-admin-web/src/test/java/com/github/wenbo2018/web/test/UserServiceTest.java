...
//    }
    ...
    public void test_loadUserByUserId_2() {
        UserDTO user=userService.loadUserByUserId(12344);
        Assert.assertTrue(user!=null);
    }

    @Test
    public void  test_loadUserByUserNameAndPassWord_3() {
        UserDTO user=userService.loadUserByUserNameAndPassWord("wenbo","33");
        Assert.assertTrue(user!=null);
    }
    @Test
    public void loadUserByUserName() {
        UserDTO user=userService.loadUserByUserName("wenbo");
        Assert.assertTrue(user!=null);
    ...
    public void  loadUserByToken() {
        UserDTO user=userService.loadUserByToken("12weffdrgere");
        Assert.assertTrue(user!=null);
