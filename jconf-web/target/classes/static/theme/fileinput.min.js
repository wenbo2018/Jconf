...
!function (e) {
    ...
    i = {
        ...
        constructor: t, _init: function (t) {
            ...
            var r, n, o, l, s, d, c, p, u, f, m = this, g = t.attr("id"), v = m.$modal, h = v.find(".btn-prev"), w = v.find(".btn-next"), _ = v.find(".btn-fullscreen"), b = v.find(".btn-borderless"), C = v.find(".btn-toggleheader"), E = m.$preview.find("#zoom-" + g);
            ...
            var u, f = this, m = f.slug(a), g = "", v = f.previewSettings[e], h = v && v.width ? v.width : "", w = v && v.height ? v.height : "", _ = d || f._renderFileFooter(m, l, v.width, o), b = f._getPreviewIcon(a), C = b && f.preferIconicPreview, E = b && f.preferIconicZoomPreview, y = function (t, o, l, d) {
            ...
            if (n.showPreview) {
                var l, s = t ? t.name : "", d = t ? t.type : "", c = t.size, p = n.slug(s), u = r === !0 && !n.isUploadable, f = i.objUrl.createObjectURL(t);
            ...
            if (this.showPreview) {
                var n, o = this, l = o._parseFileType(i), s = i ? i.name : "", d = o.slug(s), c = o.allowedPreviewTypes, p = o.allowedPreviewMimeTypes, u = o.$preview, f = c && c.indexOf(l) >= 0, m = i.size, g = "text" === l || "html" === l || "image" === l ? t.target.result : r, v = p && -1 !== p.indexOf(i.type);
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(t, function (e, i) {
                ...
                var y, x, T, S, F, P, I, k, $, A = g + e, z = u + "-" + A, D = t[e], U = D.name ? r.slug(D.name) : "", j = (D.size || 0) / 1e3, L = "", R = i.objUrl.createObjectURL(D), M = 0, O = "";
            ...
            var r = this, n = Math.min(e, 100), o = 100 > n ? r.progressTemplate : a ? r.progressErrorTemplate : 100 >= e ? r.progressTemplate : r.progressCompleteTemplate, l = r.progressUploadThreshold;
            ...
            var a, r, n, o, l, s = this, d = e.img, c = d.naturalWidth, p = d.naturalHeight, u = 1, f = s.maxImageWidth || c, m = s.maxImageHeight || p, g = !(!c || !p), v = s.imageCanvas, h = s.imageCanvasContext, w = e.typ, _ = e.pid, b = e.ind, C = e.thumb;
            ...
            var n, o, l, s, d, c, p = arguments.length > 1, u = a.isUploadable, f = 0, m = p ? t.originalEvent.dataTransfer.files : r.get(0).files, g = a.filestack.length, v = i.isEmpty(r.attr("multiple")), h = v && g > 0, w = 0, _ = function (i, t, r, n) {
                var o = e.extend(!0, {}, a._getOutData({}, {}, m), {id: r, index: n}), l = {
                    id: r,
                    index: n,
                    file: t,
                    files: m
        ...
        msgInvalidFileExtension: 'Invalid com.hawkeys.common.extension for file "{name}". Only "{extensions}" files are supported.',
        msgFileTypes: {
            image: "image",
            html: "HTML",
            text: "text",
